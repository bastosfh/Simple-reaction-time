% Tr_Square
cd '/home/flavio/Documents/Dropbox/Scripts/Octave - scripts/Psychtoolbox/TR_simples';
...
interval_to_change_path = '/home/flavio/Documents/Dropbox/Scripts/Octave - scripts/Psychtoolbox/TR_simples/interval_to_change.txt';
...
%%%%%%%%%%%%%% enderecos fisicos %%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
script_path = '/home/flavio/Documents/Dropbox/Scripts/Octave - scripts/Psychtoolbox/TR_simples';
...
Screen('TextFont',wPtr, 'Ubuntu');
Screen('TextSize',wPtr, 40);
Screen('DrawText', wPtr, 'Pressione o botão do mouse quando estiver pronto', rect(RectRight)/4.6, rect(RectBottom)/2.5, [255, 255, 255]);

Screen('TextSize',wPtr, 30);
text_ntt = sprintf('A cor do retângulo mudará %s vezes', num2str(ntt));
Screen('DrawText', wPtr, text_ntt, rect(RectRight)/4.6, rect(RectBottom)/2, [255, 255, 255]);
Screen('Flip', wPtr); %flip
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
trial_data = [interval_to_change(1:ntt) reaction_time_trials];
...
Screen('TextSize',wPtr, 40);
Screen('DrawText', wPtr, 'Muito bem!', 300, 300, [255, 255, 255]);
Screen('Flip', wPtr);
